...
class SHA1_Page extends StatefulWidget {
  const SHA1_Page({Key? key}) : super(key: key);

  @override
  State<SHA1_Page> createState() => _SHA1_PageState();
}
class _SHA1_PageState extends State<SHA1_Page> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Center(child: Text("SHA-1 Hash")),
        ),
        body: SafeArea(
            child: ListView(
              children: [
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          plaintext = tec.text;
                          setState(() {
                            encryptedText = MyEncryptionDecryption.GetSHA1(plaintext);   //encryptAES function is called from MyEncryptionDecryption class...
                          });
                        },
