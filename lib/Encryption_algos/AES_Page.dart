...
class AES_Page extends StatefulWidget {
  const AES_Page({Key? key}) : super(key: key);

  @override
  State<AES_Page> createState() => _AES_PageState();
}
class _AES_PageState extends State<AES_Page> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Center(child: Text("AES Encryption")),
        ),
        body: SafeArea(
            child: ListView(
              children: [
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          plaintext = tec.text;
                          setState(() {
                            encryptedText = MyEncryptionDecryption.encryptAES(plaintext);   //encryptAES function is called from MyEncryptionDecryption class...
                          });
                        },
